...
bot.on("ready", async () => {
  ...
  bot.user.setActivity("Trailas Kingdom Bot!", { type: "PLAYING" });

})
bot.on('guildMemberAdd', member => {

  console.log('Useer' + member.user.username + 'Welkom op *Trailas Kingdom Discord*:tada::hugging:!')
  console.log(member)
  ...
  member.guild.channels.get('580509410414034949').send ('**' + member.user.username + '**, Welkom op **Trailas Kingdom Discord**:tada::hugging:!');
...
bot.on("guildMemberRemove", member => {
  ...
  member.guild.channels.get('582196815529771010').send ('**' + member.user.username + '**, heeft **Trailas Kingdom Discord** verlaten:pensive::cry:!');
